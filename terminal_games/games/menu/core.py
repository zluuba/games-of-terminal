...
from terminal_games.scripts.minesweeper_game import start_minesweeper_game
from terminal_games.scripts.tetris_game import start_tetris_game
        ...
        while True:
            ...
            if key == curses.KEY_UP and menu_current_row_ind > 0:
                ...
                if menu_current_row_ind == 0:
                    ...
                    start_minesweeper_game(self.canvas)
                elif menu_current_row_ind == 2:
                    start_tictactoe_game(self.canvas)
                elif menu_current_row_ind == 3:
                    start_tetris_game(self.canvas)
